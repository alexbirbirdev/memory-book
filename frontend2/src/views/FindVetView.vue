    ...
    return {
      ...
      filtersSelects: {
        conflict: {
          ...
          options: ["Великая отечественная война"],
        },
        rank: {
        ...
        armyType: {
          ...
          options: ["Сухопутные войска", "Военно-морской флот", "Военно-медицинская служба", "Военно-воздушные силы", "Войска НКВД"],
        },
        armyBranch: {
          label: "Род войск",
  ...
  <div class="container mx-auto px-4 md:px-2">
    ...
    <div class="space-y-10">
      ...
      <section>
        ...
        <div class="text-center mt-6" v-if="listTotal > resultsLimit">
