...
<template>
  ...
  >
    ...
    <div class="p-4 space-y-2">
      ...
      <h2 class="text-xl font-semibold line-clamp-2">{{ article.title || "Название не добавлено" }}</h2>
      <p class="text-gray-600 text-sm line-clamp-3">{{ article.short_description || "Описание не добавлено" }}</p>
    </div>
  </router-link>
</template>
